...
export default function XircusApp({ Component, pageProps, router }) {
	...
	Component = require(`../skins/SuperFan/pages${router.route}`).default
	const theme = extendTheme(require(`../skins/SuperFan/theme`).theme)
	const messages = require(`../skins/SuperFan/i18n/${router.locale}.json`)
